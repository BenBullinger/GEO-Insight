...
Every aggregate metric used anywhere in the Facet pipeline — whether consumed from source data or produced by our scoring — has a card here. Each card captures the formal definition, authoritative source, known discontinuities, failure modes, and our specific handling.
...
## 7. Facet Gap Score $G_p(u)$ — Our Composite
