...
**Source.** Defined in `proposal/methodology.md` §3–6; implemented in `analysis/bayesian/hierarchical.py`. Cached at Level 5 of the typed semantic layer (`theta_median`, `theta_ci_lo`, `theta_ci_hi`, `theta_ci_width`).
